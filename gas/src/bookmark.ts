...
// if (bookmark.uri.includes('blog.livedoor.jp/dpdmx702')) {
//     const SSTitle = bookmark.title.substring(0, bookmark.title.lastIndexOf(' : '))
//     chat_postMessage(SLACK_ACCESS_TOKEN, CHANNEL, SSTitle); // Resend boomark title for googling
// }
